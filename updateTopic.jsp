	...
	<script src="sd.js">
		...
		<body>
			...
			if((a!=null))
			{
					...
					out.println("<h1 align='center'><br>Update Today's Topic<br></h1>");
					out.println("<form action='updateTopic1.jsp' method='get()' onsubmit='return validation();'>");
					...
					out.println("</select>");
					out.println("Date::<input onchange='updateTopic();' type='date' name='date' id='date'>");
