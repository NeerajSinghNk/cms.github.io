	...
	<%
		...
		String f=(String)request.getParameter("topic");
		String g=(String)request.getParameter("date");
		String h=(String)request.getParameter("notice");
				...
				try	
					{
						...
						i=stmt.executeUpdate("insert into practical(year1,session1,branch1,semester1,subject,topic,date1,notice,password) values('"+a+"','"+b+"','"+c+"','"+d+"','"+e+"','"+f+"','"+g+"','"+h+"','"+a1+"')");
					...
					session.setAttribute("st1","Insert Successfully");
