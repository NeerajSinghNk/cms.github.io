	...
	<script src="sd.js">
		...
		<body>
			...
			if((a!=null))
			{
					...
					out.println("<h1 align='center'><br>Delete Assignment And Practical<br></h1>");
					out.println("<form action='deletePractical1.jsp' method='get()' onsubmit='return validation();'>");
							out.println("Subject:<select onchange='deletePractical();' id='subject' name='subject' onchange='fun3();' required='required'>");
					...
					out.println("Date::<input onchange='deletePractical();' type='date' name='date' id='date'>");
					
					out.println("Topic::<select name='topic' id='topic' onchange='deletePractical();'>");
					out.println("<option>select</option>");
