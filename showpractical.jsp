...
<link rel="stylesheet" href="showpractical.css">
...
out.println("<h1 align='center'><br>Assingments And Pracyicals<br></h1>");
		...
		try
						{
							...
							ResultSet rs=stmt.executeQuery("select * from practical where  branch1='"+br+"' and semester1='"+sm+"'  ");
							System.out.println("select * from notice where  branch1='"+br+"' and semester1='"+sm+"' and date1='"+f+"'  ");
							out.println("<table class='container' border='1'><tr><th>Year</th><th>Session</th><th>Branch</th><th>Semester</th><th>Date</th><th>Subject</th><th>Topic</th><th>Questions</th></tr>");
								while(rs.next())
								{
									...
									String p=(String)rs.getString("notice");
